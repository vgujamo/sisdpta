    ...
    <div class="row align-items-end">
        <div class="col-lg-8">
            <div class="page-header-title">
                ...
                <div class="d-inline">
                    <h4>Editar Especie de Processo</h4>
                    <span></span>
                </div>
            </div>
        </div>
...
<form class="form-horizontal" role="form" action="{{ route('especie.update', $especie->id) }}" method="post">
    @csrf
                    ...
                    <div class="row p-1">
                        <div class="form-group col-sm input-group-sm">
                            ...
                            <select class="form-control @error('seccao_id') is-invalid @enderror"  name="seccao_id" id="seccao_dropdwn">
                                ...
                                <option value="{{$seccao->id}}" {{ "$seccao->id" == 'id' ? 'selected' : '' }} >{{$seccao->nome}}</option>
                                @endforeach
                            </select>
                            @error('seccao_id')
                ...
                <div class="col-sm col-sm">
                    <div class="row p-1">
                        <div class="form-group col-sm input-group-sm">
                            ...
                            <input class="form-control @error('nome') is-invalid @enderror" type="text" placeholder="Espécie" name="nome" value="{{ old('nome', $especie->nome) }}" />
                ...
                <div class="col-sm col-sm">
                    <div class="row p-1">
                        <div class="form-group col-sm input-group-sm">
                            ...
                            <textarea class="form-control @error('descricao') is-invalid @enderror" id="descricao" placeholder="Descrição do processo (Opcional)" name="descricao" rows="4" cols="10"> {{ old('descricao', $especie->descricao) }} </textarea>
