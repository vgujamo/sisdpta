...
<form class="form-horizontal" role="form" action="{{ route('pessoa.update', $pessoa->id) }}" " method="post" autocomplete="on" style="">
    ...
    <div class="row p-1">
        ...
        <div class="form-group col-sm">
            ...
            <select class="form-select @error('estado_civil') is invalid @enderror" name="estado_civil" id="estado_civil" type="text" >
    ...
    <div class="row">
        <div class="col-sm form-group input-group-sm">
            ...
            <input class="form-control @error('nacionalidade') is invalid @enderror" type="text" name="nacionalidade" placeholder="Nacionalidade" value="{{ $pessoa->nacionalidade }}" />
            @error('nacionalidade')
            <span class="invalid-feedback" role="alert">
                <b><i>{{$message}}</i></b>
            </span>
            ...
            <select class="form-control" name="">
                <option value="Moçambicana" disabled>---Nacionalidade---</option>
        ...
        <div class="col-sm form-group input-group-sm">
            ...
            <input class="form-control @error('provincia') is invalid @enderror" type="text" name="provincia_nas" placeholder="Provincia" value="{{ $pessoa->provincia_nas }}"/>
            @error('provincia')
            <span class="invalid-feedback" role="alert">
                <b><i>{{$message}}</i></b>
            </span>
        ...
        <div class="col-sm form-group input-group-sm">
            ...
            <input class="form-control" type="text" name="distrito_nas" placeholder="Distrito" value="{{ $pessoa->distrito_nas }}"/>
            @error('distrito')
            <span class="invalid-feedback" role="alert">
                <b><i>{{$message}}</i></b>
            </span>
    ...
    <div class="row p-1">
        <div class="col-sm form-group input-group-sm">
            ...
            <select class="form-select @error('tipo_doc') is-invalid @enderror" name="tipo_doc" id="tipo_doc" type="text" value="{{ $pessoa->tipo_doc}}">
