                                        ...
                                        <div class="tab-pane active" id="home1" role="tabpanel">
                                            <div class="row">
                                                <div class="col-sm form-group input-group-sm">
                                                    ...
                                                    <select class="form-control @error('nacionalidade') is-invalid @enderror" type="text" name="nacionalidade" id="nacionalidade" value="{{ old('nacionalidade') }}">
                                                ...
                                                <div class="col-sm form-group input-group-sm">
                                                    ...
                                                    <select class="form-control @error('provincia_nas') is-invalid @enderror" type="text" name="provincia_nas" id="provincia_nas" value="{{ old('provincia_nas') }}">
                                                        <option disabled selected>Selecione a Provincia</option>
                                                ...
                                                <div class="col-sm form-group input-group-sm">
                                                    ...
                                                    <select class="form-control @error('distrito_nas') is-invalid @enderror" type="text" name="distrito_nas" id="distrito_nas" value="{{ old('distrito_nas') }}">
                                                ...
                                                <!--
                                                <div class="col-sm form-group input-group-sm">
                                                    <label form="distrito_nas">Localidade</label>
                                                    <option disabled selected>Selecione a Localidade</option>
                                                    <option value=""></option>
                                                    @error('localidade_nas')
                                                    <span class="invalid-feedback" role="alert">
                                                        <b><i>{{$message}}</i></b>
                                                    </span>
                                                    @enderror
