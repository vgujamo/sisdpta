...
<form class="form-horizontal" role="form" action="{{ route('funcionario.store') }}" " method="post" autocomplete="on" style="">
    @csrf
                ...
                <div class="col-sm col-sm">
                    <div class="row p-1">
                        <div class="form-group col-sm-2 input-group-sm">
                            ...
                            <input class="form-control @error('nif') is-invalid @enderror" type="text" name="nif" placeholder="NIF" value="{{ old('nif') }}" />
                            @error('nif')
                        ...
                        <div class="form-group col-sm input-group-sm">
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label @error('sexo') is-invalid @enderror" form="Masculino">Masculino
                                    <input type="radio" id="M" name="sexo" class="form-check-input" value="M" {{ (old("sexo", $funcionario->pessoa->sexo??'')=="M"?"cheked":"") }}/>
                                    @error('sexo')
                                    <span class="invalid-feedback" role="alert">
                                        <b><i>{{$message}}</i></b>
                                    </span>
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label @error('sexo') is-invalid @enderror" form="Femenino">Femenino
                                    <input type="radio" id="" name="sexo" class="form-check-input" value="F" {{ (old("sexo", $funcionario->pessoa->sexo??'')=="F"?"cheked":"") }}/>
                                    @error('sexo')
                                    <span class="invalid-feedback" role="alert">
                                        <b><i>{{$message}}</i></b>
                                    </span>
                                        ...
                                        <div class="tab-pane" id="settings1" role="tabpanel">
                                            <div class="row p-1">
                                                ...
                                                <div class="form-group col-sm input-group-sm">
                                                    ...
                                                    <input class="form-control @error('contacto2') is-invalid @enderror" type="text" name="contacto2" placeholder="Contacto Alternativo (Opcional)" value="{{ old('contacto2',$funcionario->pessoa->contacto2 ?? '') }}"/>
                                                    @error('contacto2')
                                                    <span class="invalid-feedback" role="alert">
                                                        <b><i>{{$message}}</i></b>
                                                    </span>
